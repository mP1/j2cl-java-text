...
/**
 * For scientific numbers separates the mantissa from the exponent.
 */
final class DecimalFormatPatternComponentExponent extends DecimalFormatPatternComponent {

    /**
     * Singleton
     */
    final static DecimalFormatPatternComponentExponent INSTANCE = new DecimalFormatPatternComponentExponent();
